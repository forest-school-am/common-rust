...
- **Version:** `0.1.0` (workspace-wide) · **Edition:** 2021 · **Toolchain:** Rust 1.98.0 · **License:** MIT
...
```toml
[dependencies]
common-logging = { git = "https://github.com/forest-school-am/common-rust.git", tag = "v0.1.0" }
common-config  = { git = "https://github.com/forest-school-am/common-rust.git", tag = "v0.1.0" }
```
